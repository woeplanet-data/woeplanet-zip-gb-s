# <img src="https://github.com/woeplanet-data/woeplanet-data/raw/master/assets/woe.png" width="32" height="32"/>&nbsp;woeplanet-zip-gb-s
...
This repository contains **Zip** place records (placetype 11) that start with s in **United Kingdom**.
